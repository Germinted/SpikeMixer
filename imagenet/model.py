...
@register_model
def spikemixer_tinyimagenet(pretrained: bool = False, **kwargs) -> SpikeDynaMixer:
    """
    SpikeDynaMixer for ImageNet (224x224).

    Uses larger patch size for efficiency with larger images.
    """
    _ = pretrained
