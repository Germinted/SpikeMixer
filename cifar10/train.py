...
""" SpikeMixer CIFAR-10 Training Script
...
from model import spikemixer_s, spikemixer_m, spikemixer_l
try:
...
# Model detail
parser.add_argument('--model', default='spikemixer_s', type=str, metavar='MODEL',
                    help='Name of model to train (default: "spikemixer_s"')
...
parser.add_argument('-data-dir', metavar='DIR',default="./datasets/cifar-10-python/",
